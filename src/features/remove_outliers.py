...
from src import data  # pip install scikit-learn
...
dataset.loc[dataset["gyr_z_outlier"], "gyr_z"] = np.nanj
...
outliers_remove_df.to_pickle("../../data/interim/02_outliers_removed_chauvenet.pkl")